...
class Guidance_Generator():
    ...
    def generate_summary(self, client, traj, post_memory):
        ...
        summary = get_chat(client, query, api_type=self.args.api_type, model=self.args.gpt_version, engine=self.args.gpt_version)
    ...
    def generate_insight(self, client, post_memory):
        ...
        insight = get_chat(client, query, api_type=self.args.api_type, model=self.args.gpt_version, engine=self.args.gpt_version)
    ...
    def generate_suggestion(self, client, game_description, goal_description, action_description, pre_memory, post_memory, insight, max_num_trials):
        ...
        suggestion = get_chat(client, query, api_type=self.args.api_type, model=self.args.gpt_version, engine=self.args.gpt_version)
